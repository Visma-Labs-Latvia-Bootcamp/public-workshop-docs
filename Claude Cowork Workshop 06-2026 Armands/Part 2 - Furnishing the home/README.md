...
## What you need
- `transaction-list-requirements.md` — the starting (v0.1) requirements document.
- `requirement-review-meeting-transcript.md` — the customer review transcript.
- A short **review checklist** to work through in step 6 (your facilitator provides it).
